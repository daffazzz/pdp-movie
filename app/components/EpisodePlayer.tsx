...
const EpisodePlayer: React.FC<EpisodePlayerProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
         className={`absolute bottom-2 right-2 z-30 transition-opacity duration-300 ${(isFullscreen || isTouchDevice) ? 'opacity-50 hover:opacity-100' : ''
           }`}
      ...
      >
        <button
          ...
          className={`bg-black/70 hover:bg-white/20 text-white roundedbackdrop-blur-sm transition-all duration-200 hover:scale-110 p-1.5`}
